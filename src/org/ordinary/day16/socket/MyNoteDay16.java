...
// socket의 동작원리!!!
// ServerSocket은 지휘관느낌으로 클라이언트측의 socket에 의해 응답을 받게되면
// socket을  클라이언트측과 1대1 소통이 가능하도록 새로 생성한다.
// 이 시점부터 스트림을 통해 서로 대화가 가능해지는 것!!
// ServerSocket이 있어야 여러 클라이언트측과 대응이 가능하도록 계속 담당 socket을 만들 수 있기 때문!!
